...
public class Main {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Franco";
        String middleName = "Antonio";
        String lastName = "Beccaria";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives2 = "5.5" + "2";

        System.out.println(textFrom2Primitives);// ci aspettiamo:  true5
        System.out.println(textFrom2Primitives2);// ci aspettiamo: 5.52

        // i valori all'interno delle stringhe non sono soggetti alle normali operazioni matematiche,
        // perchè il valore di una stringa è costituito da un'unione di caratteri
    }
